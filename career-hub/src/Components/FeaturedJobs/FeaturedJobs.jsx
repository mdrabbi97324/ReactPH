...
const FeaturedJobs = () => {
    ...
    return (
        ...
        <div className="grid md:grid-cols-2 gap-6">
            {
                featuredJobs.map(featuredJob => <div key={featuredJob.id} className="border rounded-lg border-[#E8E8E8] text-left p-10  flex flex-col">
                    <div className="grow space-y-4">
                        ...
                        <button className="btn mt-6 btn-primary text-xl w-[160px] text-white font-semibold"><NavLink to="/job-details">View Details</NavLink></button>
                </div>)
            }
        </div>
    </div>
